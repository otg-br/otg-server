...
local travelDiscounts = {
    ['postman'] = {price = 10, storage = postman.Rank, value = 3},
    ['new frontier'] = {price = 50, storage = PlayerStorageKeys.TheNewFrontierMission03, value = 1}
}
...
local hints = {
    ...
    [13] = 'When you are on low health and need to run away from a NPC, switch to \'Defensive Fighting\' and the monster will hit you less severely.',
...
function StdModule.rookgaardHints(cid, message, keywords, parameters, node)
    ...
    local hintId = player:getStorageValue(PlayerStorageKeys.RookgaardHints) -- Atualizado para usar PlayerStorageKeys
