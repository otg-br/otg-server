...
enum itemAttrTypes : uint64_t {
	...
	ITEM_ATTRIBUTE_ELEMENTICE = 1ULL << 33,
	ITEM_ATTRIBUTE_ELEMENTEARTH = 1ULL << 34,
	ITEM_ATTRIBUTE_ELEMENTFIRE = 1ULL << 35,
	ITEM_ATTRIBUTE_ELEMENTENERGY = 1ULL << 36,
	ITEM_ATTRIBUTE_ELEMENTDEATH = 1ULL << 37,
	ITEM_ATTRIBUTE_ELEMENTHOLY = 1ULL << 38,
	
	// Dynamic absorb percent attributes for upgrade system
	ITEM_ATTRIBUTE_ABSORBICE = 1ULL << 39,
	ITEM_ATTRIBUTE_ABSORBEARTH = 1ULL << 40,
	ITEM_ATTRIBUTE_ABSORBFIRE = 1ULL << 41,
	ITEM_ATTRIBUTE_ABSORBENERGY = 1ULL << 42,
	ITEM_ATTRIBUTE_ABSORBDEATH = 1ULL << 43,
	ITEM_ATTRIBUTE_ABSORBHOLY = 1ULL << 44,
	ITEM_ATTRIBUTE_ABSORB_PHYSICAL = 1ULL << 45
};
